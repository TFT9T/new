...
sudo_users = {SUDO,1619524486,bot_id}
...
send(msg.chat_id_,0,"← عضو : {["..data.first_name_.."](T.ME/TFT4T)}\n•["..MODEKSA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/TFT4T)}\n← الملصق الذي ارسلته تم منعه من القروب \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@TFT4T','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
if text == '@IIIIIX' or text == '@TFT4T' or text == 'مودي البدراني' then
Text = [[
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*← الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TFT4T')..')\n*← الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'TFT4T')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
if result.sender_user_id_ == tonumber(1619524486) then
...
if result.id_ == tonumber(1619524486) then
send(msg.chat_id_, msg.id_, "←  لا يمكنك حظر مطور السورس \n")
return false 
end
usertext = '\n•العضو > ['..result.title_..'](t.me/'..(username or 'TFT4T')..')'
...
Text = ' ← عدد جهاتك > ['..Num..'](https://t.me/TFT4T) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━← 
- Ch [ᥰᎥᧁᧁꪖ - SoUrCe](https://t.me/TFT4T)
]]
